...
const SideNav = () => {
    ...
    return(
        ...
        className={`lg:left-0 ${!theme ? "bg-[#0c0c0c] text-white" : "bg-white"} lg:w-[18%]  w-[50%] p-2 flex flex-col justify-between fixed xl:top-24 top-3 z-20  xl:h-[95%] transition-colors duration-300 h-[100vh]`}>
