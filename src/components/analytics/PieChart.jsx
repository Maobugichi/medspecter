...
const PieChart =  () => {
    return(
      <div className=" h-60 relative w-full md:w-[70%] md:mx-auto">
        ...
        <img className="absolute left-25 md:left-38 lg:left-17 smallSize:left-16" src={ellip} alt=" orange ellipses" />
        <img className="absolute left-24 md:left-37  lg:left-16 bottom-6 lg:bottom-7 xxSmall:bottom-7 smallSize:left-16" src={ellips} alt="green ellipses" />
      </div>
    )
}
