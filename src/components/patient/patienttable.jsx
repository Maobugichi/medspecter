...
const PatientTable = ({isInfo,setIsInfo ,variants}) => {
    ...
    const [width, setWidth] = useState(["lg:w-[70px] w-[10%]" , "lg:w-[110px] w-[18%]","lg:w-[80px] w-[18%]","lg:w-[90px] w-[19%]","lg:w-[140px]" , "w-[100px]","w-[115px]","w-[100px]"]);
    ...
    return(
        <div className="w-[98%]  lg:w-full mx-auto border border-solid border-[#E8E8E8] limitedSize:h-[75%]   h-[110vh] rounded-xl">
            <Keys
             info={isInfo}
             check={true}
             count={count}
