...
const PatientTable = ({isInfo,setIsInfo ,variants}) => {
    ...
    const [width, setWidth] = useState(["w-[10%] lg:w-[70px] " , "w-[14%] lg:w-[110px] xl:w-[120px] 3xl:w-[125px]","w-[18%] lg:w-[80px] xl:w-[85px] 3xl:w-[90px]","w-[19%] lg:w-[90px] xl:w-[80px] ","lg:w-[140px] xl:w-[150px]" , "w-[100px]","w-[115px]","w-[100px] 3xl:w-[175px]"]);
    ...
    return(
        <div className="w-[98%]  lg:w-full 3xl:w-[93%]   mx-auto border border-solid border-[#E8E8E8]  h-[95%] pb-5 rounded-xl">
            <Keys
             info={isInfo}
             check={true}
             count={count}
