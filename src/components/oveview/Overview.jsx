...
const Overview = () => {
    ...
    return(
        <div className="xl:w-[85%] h-full  flex flex-col xl:flex-row gap-5 w-full md:pb-10 smallSize:bg-red-400 bg-green-50">
            ...
            <div className="xl:w-[35%]   md:gap-10  xl:mt-14 w-full flex flex-col justify-between">
                <Anomalies
                 show={isShow}
                 setIsShow={setIsShow}
                />
