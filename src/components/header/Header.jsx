...
const Header = () => {
    ...
    return(
        <header className="w-full h-15 grid ">
            <nav className="flex  items-center lg:w-full w-[90%] mx-auto justify-between">
                <div className="w-[40%]">
                ...
                <div className=" lg:flex w-[70%] hidden lg:justify-between h-[90%] lg:items-center">
